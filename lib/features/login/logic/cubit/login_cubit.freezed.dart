...
class Sucess<T> implements LoginState<T> {
  ...
  $SucessCopyWith<T, Sucess<T>> get copyWith =>
      _$SucessCopyWithImpl<T, Sucess<T>>(this, _$identity);
...
/// @nodoc
abstract mixin class $SucessCopyWith<T, $Res>
    implements $LoginStateCopyWith<T, $Res> {
  factory $SucessCopyWith(Sucess<T> value, $Res Function(Sucess<T>) _then) =
      _$SucessCopyWithImpl;
  @useResult
  $Res call({T data});
}

/// @nodoc
class _$SucessCopyWithImpl<T, $Res> implements $SucessCopyWith<T, $Res> {
